...
IL_005f:
		...
		{ // begin try (depth: 2)
			...
			NullCheck(L_17);
			AssemblyName_t270931938 * L_18 = VirtFuncInvoker0< AssemblyName_t270931938 * >::Invoke(24 /* System.Reflection.AssemblyName System.Reflection.Assembly::GetName() */, L_17);
...
IL_00a2:
		{
			...
			NullCheck(L_27);
			Type_t * L_31 = VirtFuncInvoker3< Type_t *, String_t*, bool, bool >::Invoke(29 /* System.Type System.Reflection.Assembly::GetType(System.String,System.Boolean,System.Boolean) */, L_27, L_30, (bool)0, (bool)1);
			V_3 = L_31;
			Type_t * L_32 = V_3;
			IL2CPP_RUNTIME_CLASS_INIT(Type_t_il2cpp_TypeInfo_var);
	...
	{ // begin try (depth: 1)
		{
			...
			NullCheck(L_0);
			FileStream_t4292183065 * L_1 = VirtFuncInvoker1< FileStream_t4292183065 *, String_t* >::Invoke(17 /* System.IO.FileStream System.Reflection.Assembly::GetFile(System.String) */, L_0, _stringLiteral2015482072);
			V_0 = L_1;
