...
namespace HoloToolkit.Unity.InputModule
{
    ...
    public class HandDraggable : MonoBehaviour, IFocusable, IInputHandler, ISourceStateHandler
    {
...
#if !UNITY_EDITOR
            System.Diagnostics.Debug.WriteLine("Hand Draggable Start");
#endif     
        }
        ...
        {
#if !UNITY_EDITOR
            System.Diagnostics.Debug.WriteLine("Hand Draggable Update");
#endif
        ...
        {
#if !UNITY_EDITOR
            System.Diagnostics.Debug.WriteLine("Hand Draggable UpdateDragging");
#endif
        ...
        {
#if !UNITY_EDITOR
            System.Diagnostics.Debug.WriteLine("Hand Draggable OnInputDown");
#endif
            if (isDragging)
            {
